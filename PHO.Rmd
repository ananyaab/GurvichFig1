...
heatmap(as.matrix(X06mMPi), Colv = NA, Rowv = NA, main = "No Pi Heatmap")
heatmap(as.matrix(X2mMPi), Colv = NA, Rowv = NA, main = "No Pi Heatmap")
heatmap(as.matrix(X5mMPi), Colv = NA, Rowv = NA, main = "No Pi Heatmap")
...
heatmap(pho00array, Colv= NA, Rowv= NA, main= "06 pi Heatmap Test")
heatmap(pho06array, Colv= NA, Rowv= NA, main= "06 pi Heatmap Test")
heatmap(pho2array, Colv= NA, Rowv= NA, main= "06 pi Heatmap Test")
heatmap(pho5array, Colv= NA, Rowv= NA, main= "06 pi Heatmap Test")
...
heatmap(newpho06array, Colv= NA, Rowv= NA, main= ".06 pi Heatmap")
heatmap(newpho2array, Colv= NA, Rowv= NA, main= ".2 pi Heatmap")
heatmap(newpho5array, Colv= NA, Rowv= NA, main= ".5 pi Heatmap")
